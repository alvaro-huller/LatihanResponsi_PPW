...
<body>
    ...
    <div class="header birutua">
        <div class="container py-2 mx-2">
            ...
            <p>Isi form untuk menambahkan film</p>
        </div>
    </div>
    <!-- form -->
    <div class="container py-4 mx-2">
        <form action="OpTambahFilm.php" method="post">
            <label for="judul_film" class="form-label">Judul Film</label><br>
            <input type="text" name="judul_film" class="form-control" required><br>
            <label for="sutradara" class="form-label">Sutradara</label><br>
            <input type="text" name="sutradara" class="form-control" required><br>
            <label for="harga_tiket" class="form-label">Harga Tiket (Rp)</label><br>
            <input type="number" name="harga_tiket" class="form-control" required><br>
